...
@if (Auth::check())
 <div id="sidebar" class="col-md-2" style="padding:0px; position:fixed;"> 
       <ul class="col-md-12 pad-free">
           ...
           <li class="col-md-12 pad-free dropdown"><a href="{!! route('reghospital') !!}" class="col-md-8">Create New Hospital</a></li>
           <li class="col-md-12 pad-free dropdown"><a href="{!! route('reglab') !!}" class="col-md-8">Create New Lab</a></li>
           <li class="col-md-12 pad-free dropdown"><a href="{!! route('regdoctor') !!}" class="col-md-8">Create New Doctor</a></li>
           <li class="col-md-12 pad-free dropdown"><a href="{!! route('doclistall', Auth::user()->id) !!}" class="col-md-8">My Doctor List</a></li>
